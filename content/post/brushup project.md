...
<img src="/post/brushup project_files/figure-html/pressure-1.png" width="1920" />
...
```
## # A tibble: 32,540 × 21
## # Groups:   collection_name [816]
##     ...1     id origi…¹ title origi…² overv…³ tagline release_…⁴ poste…⁵ popul…⁶
##    <dbl>  <dbl> <chr>   <chr> <chr>   <chr>   <chr>   <date>     <chr>     <dbl>
##  1     1 7.60e5 Orphan… Orph… en      After … "There… 2022-07-27 /pHkKb…   5089.
##  2     2 7.61e5 Beast   Beast en      A rece… "Fight… 2022-08-11 /xIGr7…   2172.
##  3     3 8.83e5 Smile   Smile en      After … "Once … 2022-09-23 /hiaeZ…   1864.
##  4     4 7.57e5 The Bl… The … en      Finney… "Never… 2022-06-22 /lr11m…   1071.
##  5     5 7.72e5 Presen… Pres… es      A man …  <NA>   2022-09-07 /dgDT3…   1021.
##  6     6 1.01e6 Sonríe  Sonr… es      <NA>     <NA>   2022-08-18 /wHowK…    940.
##  7     7 7.18e5 Jeeper… Jeep… en      Forced… "Evil … 2022-09-15 /aGBui…    822.
##  8     8 7.63e5 Nope    Nope  en      Reside… "What’… 2022-07-20 /AcKVl…    733.
##  9     9 9.27e5 Huntin… Hunt… en      Billio… "\"If … 2022-04-01 /etc6H…    575.
## 10    10 7.60e5 X       X     en      In 197… "Dying… 2022-03-17 /woTQx…    544.
## # … with 32,530 more rows, 11 more variables: vote_count <dbl>,
## #   vote_average <dbl>, budget <dbl>, revenue <dbl>, runtime <dbl>,
## #   status <chr>, adult <lgl>, backdrop_path <chr>, genre_names <chr>,
## #   collection <dbl>, collection_name <chr>, and abbreviated variable names
